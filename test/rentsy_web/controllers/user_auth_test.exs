defmodule RentsyWeb.UserAuthTest do
  use RentsyWeb.ConnCase, async: true

  alias Rentsy.Accounts
  alias RentsyWeb.UserAuth
  import Rentsy.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RentsyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      RentsyWeb.Endpoint.subscribe(live_socket_id)
