defmodule Rentsy.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Rentsy.Repo)
  ...
  """
  def valid_password?(%Rentsy.Accounts.User{hashed_password: hashed_password}, password)
