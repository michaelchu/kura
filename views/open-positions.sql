...
WITH open_pos as (
    ...
    group by symbol, strategies.display, root, expiration, type, strike, asset_type, account_id
    having sum(quantity) <> 0
     ...
     open_avgs as (
         ...
         group by op.symbol, op.strategy, op.root, op.expiration, op.type, op.strike, op.asset_type, op.account_id
     )
...
GROUP BY oa.symbol, oa.strategy, oa.root, oa.avg_price, oa.expiration, oa.type, oa.strike, oa.asset_type,
